...
| GitHub Actions run `34080366708` | Passed 426 tests, one-file build, signed manifest, and stable release publication | Public v0.6.10 tag peels to commit `00a89b2`; release automation is distinct from gameplay acceptance. |
| Downloaded v0.6.10 release assets | Manifest signature, 17,933,766-byte size, SHA-256 `E2ABD12562C615155E0B97F146B66BBB7FD6209863ACEE9391321D12AEC9621E`, GUI startup, exact-path cleanup, and public stable-update lookup passed | Verifies the published executable and update metadata. The reported R4 Seeds have separate live-native and in-game reveal evidence. |
