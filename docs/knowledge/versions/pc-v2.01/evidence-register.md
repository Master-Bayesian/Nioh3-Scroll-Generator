...
| GitHub Actions run `34080366708` | Passed 423 tests, one-file build, signed manifest, and stable release publication | Public v0.6.10 tag peels to commit `00a89b2`; release automation is distinct from gameplay acceptance. |
